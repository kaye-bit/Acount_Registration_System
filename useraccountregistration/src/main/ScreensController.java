...
class ScreensController extends StackPane {
    ...
    public boolean loadScreen(String hashID, String resource) {
        try {
            ...
            switch (resource) {
                case "Screen3.fxml":
                    controller3 = fxmlloaderObj.getController();
                    break;
                default:
                    break;
            }
    ...
    void initiliazeUser() {
        try {
            ...
            if(controller3 instanceof Screen3Controller) {
                Screen3Controller screen3Controller = (Screen3Controller) controller3;
                screen3Controller.initializeUser();                 
            }           


        } catch (Exception e) {
            System.err.println("INITLIAZE USER EXCEPTION");
        }
    }
